    ...
    <section id="services" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
                <h3 className="text-amber-600 font-bold tracking-wide uppercase text-2xl font-heading">Our Expertise</h3>
                <h2 className="text-4xl font-extrabold text-gray-900 mt-2 font-heading">
                    Empowering Education Through Expert Home Tutoring
                </h2>
                <p className="mt-4 text-gray-600 max-w-2xl mx-auto text-lg font-body">
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-20">
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                    <h4 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                        <span className="w-8 h-1 bg-amber-500 rounded mr-3 font-heading"></span>
                        For Teachers
                    </h4>
                    ...
                    <p className="italic font-medium text-amber-600 bg-amber-50 p-3 rounded-lg border-l-4 border-amber-400 font-body">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                    <h4 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                        <span className="w-8 h-1 bg-indigo-500 rounded mr-3 font-heading"></span>
                    ...
                    <p className="italic font-medium text-amber-600 bg-amber-50 p-3 font-body rounded-lg border-l-4 border-amber-400">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                {services.map((service, index) => (
                    ...
                    >
                        ...
                        <h4 className="text-xl font-bold mb-3 text-gray-900 font-heading">{service.title}</h4>
            ...
            <div className="mt-16 text-center">
                <button className="bg-amber-500 text-black px-8 py-3 font-body rounded-full cursor-pointer font-semibold hover:bg-amber-700 transition shadow-lg">
