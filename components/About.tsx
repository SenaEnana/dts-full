    ...
    <section id="about" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            <h3 className="text-2xl font-bold text-amber-600 uppercase tracking-widest font-heading mb-2">Our Story</h3>
            <h2 className="text-4xl font-bold text-gray-900 mb-6 font-heading leading-tight">
            ...
            <div className="grid grid-cols-2 font-body gap-6">
              {values.map((v, i) => (
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-8 bg-gray-50 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <h4 className="text-xl font-bold text-gray-900 mb-3 font-heading">Our Mission</h4>
          ...
          <div className="p-8 bg-gray-50 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <h4 className="text-xl font-bold text-gray-900 mb-3 font-heading">Our Vision</h4>
            <p className="text-gray-600 font-body">
